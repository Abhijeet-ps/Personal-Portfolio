...
firstPlatform.addEventListener('click',()=>{
    window.open("https://twitter.com/AbhijeetPsk_");
});
secondPlatform.addEventListener('click',()=>{
    window.open("mailto:abhijeetpsk7@outlook.com");
});
thirdPlatform.addEventListener('click',()=>{
    window.open("https://github.com/Abhijeet-ps");
});
fourthPlatform.addEventListener('click',()=>{
    window.open("https://www.linkedin.com/in/abhijeet-p-sabu-557b891b3/");
});